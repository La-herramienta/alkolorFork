  ...
  return (
    <div className="bg-gray-50 w-full h-full">
      ...
      <div className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <p>
          <strong>ALCOLOR</strong>, en el desarrollo de su actividad
          empresarial, lleva a cabo el tratamiento de datos personales relativos
          a personas naturales que están contenidos y son tratados en bases de
